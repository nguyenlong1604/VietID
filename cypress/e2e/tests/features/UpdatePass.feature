...
#   Scenario: Cập nhật mật khẩu không thành công khi nhập mật khẩu mới với độ dài 7 ký tự
#     Given Tôi truy cập vào website và login thành công với username = "0855662472" và password = "Long1604@@"
#     Then Màn hình hiển thị đầy đủ thông tin Profile người dùng
#     When Người dùng chọn tùy chọn 'Cập nhật'
#     Then Màn hình hiển thị đầy đủ thông tin để Cập nhật mật khẩu
...
#   # Scenario: Cập nhật mật khẩu thành công khi nhập mật khẩu mới với độ dài 8 ký tự
#   #   Given Tôi truy cập vào website và login thành công với username = "0855662472" và password = "Long1604@@"
#   #   Then Màn hình hiển thị đầy đủ thông tin Profile người dùng
#   #   When Người dùng chọn tùy chọn 'Cập nhật'
#   #   Then Màn hình hiển thị đầy đủ thông tin để Cập nhật mật khẩu
...
#   # Scenario: Cập nhật mật khẩu thành công khi nhập mật khẩu mới với độ dài 32 ký tự
...
#   Scenario: Cập nhật mật khẩu không thành công khi nhập mật khẩu mới với độ dài 33 ký tự
#     Given Tôi truy cập vào website và login thành công với username = "0855662472" và password = "Long1604@@"
#     Then Màn hình hiển thị đầy đủ thông tin Profile người dùng
#     When Người dùng chọn tùy chọn 'Cập nhật'
#     Then Màn hình hiển thị đầy đủ thông tin để Cập nhật mật khẩu
...
#     When Tôi nhấn nút 'THAY ĐỔI'
#     Then Tôi nhìn thấy thông báo với lỗi khi nhập mật khẩu mới và nhập lại mật khẩu mới không khớp "Mật khẩu xác nhận không trùng khớp"
...
#   Scenario: Cập nhật mật khẩu không thành công khi không nhập mật khẩu mới và nhập lại mật khẩu mới
#     Given Tôi truy cập vào website và login thành công với username = "0855662472" và password = "Long1604@@"
#     Then Màn hình hiển thị đầy đủ thông tin Profile người dùng
#     When Người dùng chọn tùy chọn 'Cập nhật'
#     Then Màn hình hiển thị đầy đủ thông tin để Cập nhật mật khẩu
...
#     When Tôi nhập xác nhận mật khẩu mới với mật khẩu = "Long1604@@"
#     When Tôi nhấn nút 'THAY ĐỔI'
#     Then Tôi nhìn thấy thông báo với lỗi khi không nhập mật khẩu mới và nhập lại mật khẩu mới "Mật khẩu xác nhận không khớp."

#   Scenario: Cập nhật mật khẩu không thành công khi nhập mật khẩu mới và không nhập lại mật khẩu mới
#     Given Tôi truy cập vào website và login thành công với username = "0855662472" và password = "Long1604@@"
#     Then Màn hình hiển thị đầy đủ thông tin Profile người dùng
#     When Người dùng chọn tùy chọn 'Cập nhật'
#     Then Màn hình hiển thị đầy đủ thông tin để Cập nhật mật khẩu
...
#     When Tôi nhấn nút 'THAY ĐỔI'
#     Then Tôi nhìn thấy thông báo với lỗi khi nhập mật khẩu mới và không nhập lại mật khẩu mới "Mật khẩu xác nhận không khớp."
